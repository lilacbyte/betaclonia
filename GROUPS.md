...
Please read The OG Game gamepedia.com/Breaking to learn how digging times work in The OG Game, as Mineclonia is based on the same system.
...
These groups correspond to the The OG Game materials. They classify the block into a type, indicating what the block is “made off”.
...
Note that not all The OG Game materials are used so far. More The OG Game materials will lilely only be added when they are needed for a concrete use case.
