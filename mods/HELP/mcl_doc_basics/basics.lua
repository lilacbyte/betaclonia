...
doc.add_entry("basics", "hunger", {
	name = S("Food and Healing"),
	data = { text =
	S("Food restores health directly in this game variant.").."\n\n"..

	S("Core food rules:").."\n\n"..
	S("• Eating food heals hearts immediately").."\n"..
	S("• Different foods heal different amounts").."\n"..
	S("• Some foods are harmful and may damage you instead").."\n"..
	S("• Poisonous foods can trigger additional damage effects").."\n"..
	S("• There is no hunger meter").."\n\n"..

	S("Tip: Keep safe food ready for fights and exploration.")
...
doc.add_entry("basics", "minetest", {
	...
	data = {
		text =
S("Luanti is a Free Software game engine for games based on voxel gameplay, inspired by InfiniMiner, Minecraft, and the like. Luanti, formerly called Minetest was originally created by Perttu Ahola (alias “celeron55”).").."\n\n"..
...
S("betaclonia is a game that is built on top of the Luanti engine that is inspired by Minecraft. There are many other games for Luanti however, that can be installed from the main menu content browser.")
}})
