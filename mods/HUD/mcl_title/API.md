...
```lua
--show a title in the HUD with The OG Game color "gold" 
...
--show an actionbar in the HUD (above the hotbar) with The OG Game color "red"
mcl_title.set(player, "subtitle", {text="dummy actionbar", color="red"})

--show a title in the HUD with The OG Game color "gold" staying for 3 seconds (override stay setting)
