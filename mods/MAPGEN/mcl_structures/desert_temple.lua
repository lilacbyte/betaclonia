	...
	loot = {
		["mcl_chests:chest" ] ={
		{
			...
			items = {
				...
				{ itemstring = "mcl_mobitems:feather", weight = 25, amount_min = 3, amount_max=7 },
				{ itemstring = "mcl_mobitems:feather", weight = 25, amount_min = 1, amount_max=3 },
					{ itemstring = "mcl_books:book", weight = 20 },
				{ itemstring = "mcl_mobitems:saddle", weight = 20, },
				{ itemstring = "mcl_core:apple_gold", weight = 20, },
				{ itemstring = "mcl_core:gold_ingot", weight = 15, amount_min = 2, amount_max = 7 },
				{ itemstring = "mcl_core:iron_ingot", weight = 15, amount_min = 1, amount_max = 5 },
				{ itemstring = "mcl_core:gold_ingot", weight = 15, amount_min = 1, amount_max = 3 },
