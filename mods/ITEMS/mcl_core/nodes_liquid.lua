...
minetest.register_node("mcl_core:water_flowing", {
	...
	-- Hardness intentionally set to infinite instead of 100 (The OG Game value) to avoid problems in creative mode
	_mcl_hardness = -1,
})
...
minetest.register_node("mcl_core:lava_flowing", {
	...
	buildable_to = true,
	drop = "",
	--[[ Drowning in The OG Game deals 2 damage per second.
