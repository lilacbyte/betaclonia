...
function mcl_doors:register_door(name, def)
	...
	local function lsafetycheck(ltheitem)
		if ltheitem ~= nil then
			return ltheitem
		else
			return "0"
		end
	...
	minetest.register_node(":"..name.."_b_1", {
		tiles = {"blank.png", lsafetycheck(tt[2]).."^[transformFXR90", lsafetycheck(tb[2]), lsafetycheck(tb[2]).."^[transformFX", lsafetycheck(tb[1]), lsafetycheck(tb[1]).."^[transformFX"},
	...
	minetest.register_node(":"..name.."_t_1", {
		tiles = {lsafetycheck(tt[2]).."^[transformR90", "blank.png", lsafetycheck(tt[2]), lsafetycheck(tt[2]).."^[transformFX", lsafetycheck(tt[1]), lsafetycheck(tt[1]).."^[transformFX"},
		use_texture_alpha = minetest.features.use_texture_alpha_string_modes and "clip" or true,
		paramtype = "light",
		paramtype2 = "facedir",
		sunlight_propagates = true,
	...
	minetest.register_node(":"..name.."_b_2", {
		tiles = {"blank.png", lsafetycheck(tt[2]).."^[transformFXR90", lsafetycheck(tb[2]).."^[transformI", lsafetycheck(tb[2]).."^[transformFX", lsafetycheck(tb[1]).."^[transformFX", lsafetycheck(tb[1])},
		use_texture_alpha = minetest.features.use_texture_alpha_string_modes and "clip" or true,
		paramtype = "light",
		paramtype2 = "facedir",
		sunlight_propagates = true,
	...
	minetest.register_node(":"..name.."_t_2", {
		tiles = {lsafetycheck(tt[2]).."^[transformR90", "blank.png", lsafetycheck(tt[2]).."^[transformI", lsafetycheck(tt[2]).."^[transformFX", lsafetycheck(tt[1]).."^[transformFX", lsafetycheck(tt[1])},
		use_texture_alpha = minetest.features.use_texture_alpha_string_modes and "clip" or true,
		paramtype = "light",
		paramtype2 = "facedir",
		sunlight_propagates = true,
