...
mcl_armor.register_set({
	...
	--this is used to calculate each armor piece durability with the The OG Game algorithm
	...
	--See The OG Game wiki/w/Armor#Armor_toughness for more explanations
	--default: 0
	toughness = 2,
	...
	--this is used to generate automaticaly armor crafts based on each element type folowing the regular The OG Game pattern
...
Existing armor enchantments in The OG Game improve most of the time how the armor protect the entity from damage.
...
mcl_armor.register_protection_enchantment({
	...
	--see The OG Game Wiki for more informations
	--The OG Game gamepedia.com/Armor#Damage_protection
	--The OG Game gamepedia.com/Armor#Enchantments
	factor = 1,
